...
| 12 | F8 | **Puntos Plus Business** (flotas): diseño técnico en `docs/PUNTOS-PLUS-BUSINESS.md` (7 etapas B-E1…E7) | 180-250 hs | Media | 📐 **DISEÑO propuesto** (4-sep) — pendiente de validación del dueño y de arranque de B-E1 |
...
**Total restante estimado (v4.2):** ≈4-8 hs de desarrollo (solo go-live) + **F8 Puntos Plus Business (180-250 hs, diseño propuesto)** + F9 opcional restante + gestiones externas del dueño (PROPER, Twilio, Play/Apple). F6 (72-93 hs estimadas) se ejecutó entre el 15-ago y el 3-sep; el plan v3.0 de 550-750 hs queda ejecutado en ~95%.
...
- **F8 — Puntos Plus Business:** el spike (D5) se cerró con GO comercial el 4-sep-2026 (empresas interesadas). Diseño técnico propuesto en `docs/PUNTOS-PLUS-BUSINESS.md`: modelo de datos con libro mayor, rol `flota`, vales como canjes compatibles con la API de PROPER, apartado "Mi flota" en la app, facturación y métricas; 7 etapas, 180-250 hs. Pendiente: validación del dueño de los puntos abiertos (§8) y arranque de B-E1.
...
- **F8 → Puntos Plus Business (misma tarde):** el dueño confirmó empresas
  ...
  `docs/PUNTOS-PLUS-BUSINESS.md` (v0.1, 4 puntos abiertos en su §8).
