...
Object.assign(MODELS, {
  ...
  sportage: {
    ...
    mergeInto: { rB: 'red', rD: 'red2', rF: 'darkred', rG: 'darkred', black: 'deep', gray: 'char' },
    blotchBox: [350, 175, 700, 350], // parabrisas
    blotchSrc: ['red', 'rB', 'red2', 'rD', 'darkred', 'rF', 'rG'],
    fixed: [],
    whiteBoxes: [
  ...
  cx5: {
    ...
    blotchBox: [520, 190, 900, 340], // parabrisas
  ...
  runner: {
    ...
    mergeInto: { rB: 'red', rD: 'red2', rF: 'darkred', rG: 'darkred', black: 'deep', gray: 'char' },
    blotchBox: [420, 175, 760, 330], // parabrisas
    blotchSrc: ['red', 'rB', 'red2', 'rD', 'darkred', 'rF', 'rG'],
    fixed: [],
    whiteBoxes: [
  ...
  rav4: {
    ...
    mergeInto: { rB: 'red', rD: 'red2', rF: 'darkred', rG: 'darkred', black: 'deep', gray: 'char' },
    blotchBox: [400, 195, 760, 340], // parabrisas
    blotchSrc: ['red', 'rB', 'red2', 'rD', 'darkred', 'rF', 'rG'],
    fixed: [],
    whiteBoxes: [
...
const LAMPS = {
  ...
  runner:   { fill: '#C2C1C1', boxes: [[418, 425, 668, 512], [102, 419, 166, 484], [530, 578, 585, 632]], extra: [[798, 173, 1285, 205, 240, 256]] },
  ...
  hilux:    { fill: '#CCCCCC', boxes: [[440, 407, 680, 494], [109, 415, 145, 476]] },
...
(async () => {
  ...
  {
    const SPECIAL = new Set(['red', 'darkred', 'green', 'orange', 'darkorange', 'teal', 'darkteal', 'blue', 'amber', 'white', 'taillight', 'tailred', 'spring', 'navy', 'springsilver', 'hubdot', 'ring', 'cabin', 'lamp']);
