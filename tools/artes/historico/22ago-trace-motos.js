...
Object.assign(MODELS, {
  ...
  xr: { // el hueco tras el motor era fondo encerrado pintado de blanco → max 247
    file: 'HONDA, XR.png',
    classes: [
    ...
    minPx: 400, // mordiscos grises del AA en el borde del panel blanco
    fixed: [],
    whiteBoxes: [[380, 300, 1120, 700, 233, 248]],
  ...
  dita: { // rasgado/picado: los oscuros son un continuo 41-85 (anclas viejas
    ...
    whiteBoxes: [[220, 380, 720, 640, 228, 246], [1000, 290, 1320, 580, 228, 246], [200, 620, 560, 905, 234, 246], [1060, 610, 1420, 905, 234, 246]],
...
(async () => {
  ...
  const classOf = (i) => {
    ...
    if (wb && r >= (wb[4] || 235) && g >= (wb[4] || 235) && b >= (wb[4] || 235)
        && r < (wb[5] || 256) && g < (wb[5] || 256) && b < (wb[5] || 256)) return WHITE_I;
