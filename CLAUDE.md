...
- **Encuestas:** límite 5/día, espera mínima 1:15 min (`SURVEY_WAIT` 75s, 14-ago-2026) OCULTA al cliente (sin contador visible en la UI), la 5ª otorga boleto de rifa gratis. La encuesta pendiente persiste en localStorage `pp_survey_pending` (sobrevive la recarga de la PWA al volver de Shell).
